...
const Navbar: React.FC<NavbarProps> = ({ className }) => {
  return (
    <div className={`${className} items-center`}>
      <div className="w-[50px] h-[50px] aspect-square block rounded-2xl">
        <img
          src={logo}
      ...
      <nav className="flex w-[80%] md:w-auto md:flex-col items-center justify-center md:justify-between gap-1 sm:gap-5 md:gap-5">
        <Navicon active={false} className="active" onClick={() => {}}>
          <GoPulse className="text-xl md:text-3xl text-gray_default" />
        </Navicon>
        <Navicon active={false} className="active" onClick={() => {}}>
          <HiOutlineChatBubbleLeftRight className="text-xl md:text-3xl text-gray_default" />
        </Navicon>
        <Navicon active={false} className="active" onClick={() => {}}>
          <PiStack className="text-xl md:text-3xl text-gray_default" />
        </Navicon>
        <Navicon active={true} className="active" onClick={() => {}}>
          <div className="rounded-md p-[0.1rem] md:p-1 border-[3px] border-gray_default">
            <HiChartBar className="md:text-xl text-gray_default" />
          </div>
        </Navicon>
      </nav>
      <div className="w-[50px] h-[50px] aspect-square block rounded-full md:mt-auto">
        <img
